...
describe("Namespaces", () => {
  ...
  describe(".instance", () => {
    ...
    it("should define all expected paths", () => {
      ...
      expect(
        amadeus.ordering.transferOrder("XXX").transfers.cancellation
      ).toBeDefined();
    ...
    it("should define all expected .post methods", () => {
      ...
      expect(
        amadeus.ordering.transferOrder("XXX").transfers.cancellation.post
      ).toBeDefined();
    });
    ...
    it(".amadeus.referenceData.locations.airports.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.referenceData.locations.airports.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.referenceData.locations.cities.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.referenceData.locations.cities.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.referenceData.locations.hotels.byHotels.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.referenceData.locations.hotels.byHotels.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.referenceData.locations.pointsOfInterest.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.referenceData.locations.pointsOfInterest.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it('.amadeus.referenceData.locations.pointOfInterest("XXX").get', () => {
      ...
      amadeus.referenceData.locations.pointOfInterest("XXX").get();
      expect(amadeus["client"].get).toHaveBeenCalledWith(
        "/v1/reference-data/locations/pois/XXX"
      );
    });
    ...
    it(".amadeus.referenceData.airlines.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.referenceData.airlines.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.shopping.flightDestinations.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.shopping.flightDestinations.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.booking.flightOrder().get", () => {
      ...
      expect(amadeus["client"].get).toHaveBeenCalledWith(
        "/v1/booking/flight-orders/XXX"
      );
    });

    it(".amadeus.booking.flightOrder().get throws when not providing an orderId", () => {
      // @ts-expect-error
      expect(() => amadeus.booking.flightOrder().get()).toThrow(
        new Error("MISSING_REQUIRED_PARAMETER")
      );
    });

    it(".amadeus.booking.flightOrder().delete", () => {
      amadeus["client"].delete = vi.fn();
      amadeus.booking.flightOrder("XXX").delete();
      expect(amadeus["client"].delete).toHaveBeenCalledWith(
        "/v1/booking/flight-orders/XXX"
      );
    });
    ...
    it(".amadeus.booking.flightOrder().delete throws when not providing an orderId", () => {
      // @ts-expect-error
      expect(() => amadeus.booking.flightOrder().delete()).toThrow(
        new Error("MISSING_REQUIRED_PARAMETER")
      );
    });
    ...
    it(".amadeus.travel.predictions.tripPurpose.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.travel.predictions.tripPurpose.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
    ...
    it(".amadeus.airport.directDestinations.get", () => {
      amadeus["client"].get = vi.fn();
      amadeus.airport.directDestinations.get({} as any);
      expect(amadeus["client"].get).toHaveBeenCalledWith(
